...
type ImageBaseProps<
  D extends React.ElementType = ImageBaseTypeMap['defaultComponent'],
  P = {}
> = OverrideProps<ImageBaseTypeMap<P, D>, D>
...
export const ImageBase: ImageBaseType = (props: ImageBaseProps) => {
  const { component: Component, className, src, alt, ...rest } = {
    ...defaultProps,
    ...props,
  }
  ...
  return (
    <Component {...rest} src={src} alt={alt} className={classOfComponent} />
  )
}
