...
`@hdbank/icons/components/{IconNames}` exported svg component to render inside `Icon` component.

#### Usage
```tsx
import { Icon } from '@hdbank/ui';
import ArrowDown from '@hdbank/icons/components/ChevronBottom';
